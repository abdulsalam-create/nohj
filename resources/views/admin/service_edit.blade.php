...
<body>
    <div class="container-fluid position-relative d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{ route('all.service') }}" class="dropdown-item active">Services</a>
        ...
        <div class="content">
            ...
            <form method="POST" action="{{ route('service.submit',$item->id)  }}">
            @csrf
                        ...
                        <input type="hidden" name="id" value="{{ $item->id }}">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="description" placeholder="Leave a comment here"
                                    id="floatingTextarea" style="height: 150px;">{{ $item->service_desc }}</textarea>
