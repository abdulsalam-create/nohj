                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="{{ route('all.vid') }}" class="dropdown-item active">Home Vid</a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-12">
                        ...
                        <input type="hidden" name="id" value="">
                            <h6 class="mb-4">Edit HomeVid</h6>
                            <div class="form-floating mb-3">
                                <input type="text" name="title" class="form-control" id="floatingInput"
                                    placeholder="name@example.com" value="{{ $item->over_text }}">
                                <label for="floatingInput">Overlay Text</label>
                            </div>
                   
                            <div class="form-floating">
                            <div class="form-floating mb-3">
                                <input type="text" name="desc" class="form-control" id="floatingInput"
                                    placeholder="name@example.com" value="{{ $item->over_desc }}">
                                <label for="floatingInput">Overlay Description</label>
                            </div>
                            <div class="form-floating">
                            <div class="mb-3">
                                    <input class="form-control bg-dark" name="video" type="file" id="image-upload" >
                                    <label for="formFile" class="form-label">Select Video</label>
                                    <div id="preview-container" class="rounded mod-imgselect"></div>
                            </div>
                       
                                <div class="mb-3">
                                    <input class="form-control bg-dark" name="homevid" type="file" id="image-upload" >
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">Carternimation</a>, All Right Reserved. 
                        </div>
                    </div>
                </div>
            </div>
