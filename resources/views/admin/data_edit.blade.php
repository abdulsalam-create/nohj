...
<body>
    <div class="container-fluid position-relative d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="{{ route('all.data') }}" class="dropdown-item active">Data</a>
        ...
        <div class="content">
            ...
            <form method="POST" action="{{ route('update.data',$item->id)  }}">
            @csrf
                        ...
                        <input type="hidden" name="id" value="{{ $item->id }}">
                            ...
                            <div class="form-floating mb-3">
                                <input type="number" name="number" class="form-control" id="floatingInput"
                                    placeholder="name@example.com" value="{{ $item->number }}">
                                <label for="floatingInput">Number</label>
                            </div>
                   
                            <div class="form-floating mb-3">
                                <input type="text" name="detail" class="form-control" id="floatingInput"
                                    placeholder="name@example.com" value="{{ $item->details }}">
